...
class BoardBuilderForSix extends boardBuilder {
    /**
    ...
    public void setTriangles() {
        ...
        addToTriangle(gameBoard.getField().get(4), color.PURPLE, 4);
        addToTriangle(gameBoard.getField().get(5), color.ORANGE, 4);
